...
export const SKILLS: Skill[] = [
  ...
  {
    id: 'cd-unfreeze',
    name: "存单解冻通知书及手工备款材料生成工具",
    category: "中后台文书自动化 Skill",
    scene: "对中后台 + 对自己",
    sceneTags: ['对中后台', '对自己'],
    audience: ["客户经理", "中后台", "柜台/放款中心"],
    input: ["客户名称", "存单账号", "存单金额", "存单到期日", "授信到期日", "经办支行", "手工管控初审/终审", "出票人"],
    output: ["现金等价物解除质押审批流程 OA（题目/正文/手工管控）", "公文分发流程 OA（手工备款申请）", "存单解冻通知书（柜台版）", "支行手工备款票据清单模板"],
    form: "网页",
    status: "在线可用",
    toolRoute: "/cd-unfreeze",
    description: "存单到期归还授信场景，一次填写客户必填信息与本支行手工管控人员，自动生成两个 OA、解冻通知书与备款票据清单，全部支持一键复制；不写死任何支行 / 客户 / 管控人员，本行实际填写即可。"
  },
  {
